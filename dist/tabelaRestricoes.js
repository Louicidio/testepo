...
exports.nomesBase = exports.matrizComArtificiais = exports.operadores = void 0;
...
function matrizExp(MatrizA, operadores) {
    ...
    for (let i = 0; i < numRestricoes; i++) {
        ...
        if (operadores[i] === "<=") {
            ...
            linha[numVarsOriginais + numFolgas + numExcessos + artificialAtual] = 1; // artificial excesso
            excessoAtual++;
            artificialAtual++;
        }
        else if (operadores[i] === "=") {
...
const matrizComArtificiais = matrizExp(lertexiste_1.MatrizA, operadores); // matriz com folgas, excessos e artificiais
exports.matrizComArtificiais = matrizComArtificiais;
function montarNomesVariaveis(numVarsOriginais, operadores) {
    const nomes = [];
    // Variáveis originais
    for (let i = 1; i <= numVarsOriginais; i++)
        nomes.push(`x${i}`);
...
const nomesBase = nomesBasesCompletos(operadores, lertexiste_1.folgas);
exports.nomesBase = nomesBase;
